$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'id', name: 'articleId', index: 'blogId', width: 50, key: true, hidden: true},
            {label: '标题', name: 'articleTitle', index: 'articleTitle', width: 140},
            {label: '浏览量', name: 'articlesParam.articleViews', index: 'articlesParam.articleViews', width: 60},
            {label: '状态', name: 'articleStatus', index: 'articleStatus', width: 60, formatter: statusFormatter},
            {label: '博客分类', name: 'category.categoryName', index: 'category.categoryName', width: 60},
            {label: '添加时间', name: 'articleDate', index: 'articleDate', width: 90}
        ],
        height: 700,
        rowNum: 10,
        rowList: [10, 20, 50],
