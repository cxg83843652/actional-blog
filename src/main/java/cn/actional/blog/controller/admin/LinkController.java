...
public class LinkController {
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(linkService.selectByPage(pageUtil));
    }
    ...
    public Result info(@PathVariable("id") Integer id) {
        ActionLink link = linkService.selectByPrimaryKey(id);
    ...
    public Result update(@RequestParam("linkId") Integer linkId,
                       ...
                       @RequestParam("linkRank") Integer linkRank,
                       @RequestParam("linkDescription") String linkDescription) {
        ActionLink tempLink = linkService.selectByPrimaryKey(linkId);
        if (tempLink == null) {
